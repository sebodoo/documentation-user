...
.. image:: media/agreements-configure-types.png
   :align: center
   :alt: Congifure purchase agreements types in Odoo Purchase
...
closes the call for tenders. You can now proceed with your purchase order as you would for a regular
one.
